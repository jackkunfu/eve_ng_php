...
$(document).on('keydown', 'body', function (e) {
  ...
  if (KEY_CODES.escape == e.which) {
    ...
    $('#mouse_frame').remove();
    $('#lab-viewport')
      .removeClass('lab-viewport-click-catcher')
      .data('prevent-contextmenu', false);
...
$(document).on('contextmenu', '.context-menu', function (e) {
  ...
  if (
    isFreeSelectMode &&
    !$(this).is('.node_frame.free-selected', '.node_frame.free-selected *')
  ) {
    // prevent 'contextmenu' on non Free Selected Elements
  ...
  if ($(this).hasClass('node_frame')) {
    ...
    var node_id = $(this).attr('data-path'),
      ...
      body =
        '<li>' +
        '<a class="menu-collapse" data-path="menu-manage" href="javascript:void(0)"><i class="glyphicon glyphicon-chevron-down"></i> ' +
        MESSAGES[75] +
        '</a>' +
        '</li>' +
        '<li>' +
        '<a class="action-nodestart context-collapsible menu-manage" data-path="' +
        node_id +
        '" data-name="' +
        title +
        ...
        '</li>' +
        '<li>' +
        '<a class="action-nodestop context-collapsible menu-manage" data-path="' +
        node_id +
        '" data-name="' +
        title +
        '" href="javascript:void(0)">' +
        ...
        '</li>' +
        '<li>' +
        '<a class="action-nodewipe context-collapsible menu-manage" data-path="' +
        node_id +
        '" data-name="' +
        title +
        '" href="javascript:void(0)">' +
    ...
    if (ROLE == 'admin' || ROLE == 'editor') {
      body +=
        ...
        '</li>' +
        '<li>' +
        '<a class="action-nodeexport context-collapsible menu-edit" data-path="' +
        node_id +
        '" data-name="' +
        title +
        '" href="javascript:void(0)">' +
        ...
        '</li>' +
        '<li>' +
        '<a class="action-nodeinterfaces context-collapsible menu-edit" data-path="' +
        node_id +
        '" data-name="' +
        title +
        '" href="javascript:void(0)">' +
        ...
        '</li>' +
        '<li>' +
        '<a class="action-nodeedit context-collapsible menu-edit" data-path="' +
        node_id +
        '" data-name="' +
        title +
        '" href="javascript:void(0)">' +
        ...
        '</li>' +
        '<li>' +
        '<a class="action-nodedelete context-collapsible menu-edit" data-path="' +
        node_id +
        '" data-name="' +
        title +
        '" href="javascript:void(0)">' +
    ...
    if (isFreeSelectMode) {
      body =
        ...
        '</li>' +
        '<li>' +
        '<a class="action-nodestart-group context-collapsible menu-manage" href="javascript:void(0)"><i class="glyphicon glyphicon-play"></i> ' +
        MESSAGES[153] +
        '</a>' +
        '</li>' +
        '<li>' +
        '<a class="action-nodestop-group context-collapsible menu-manage" href="javascript:void(0)"><i class="glyphicon glyphicon-stop"></i> ' +
        MESSAGES[154] +
        '</a>' +
        '</li>' +
        '<li>' +
      ...
      if (ROLE == 'admin' || ROLE == 'editor') {
        body +=
          ...
          '<li>' +
          '<a class="action-nodeexport-group context-collapsible menu-manage" href="javascript:void(0)"><i class="glyphicon glyphicon-save"></i> ' +
          MESSAGES[129] +
          '</a>' +
          '</li>' +
          '<li>' +
          '<a class="action-nodesbootsaved-group" href="javascript:void(0)"><i class="glyphicon glyphicon-floppy-saved"></i> ' +
          MESSAGES[139] +
          '</a>' +
          '</li>' +
          '<li>' +
      ...
      body +=
        ...
        '<li role="separator" class="divider"></li>' +
        '<li>' +
        '<a class="action-nodesbootdelete-group" href="javascript:void(0)"><i class="glyphicon glyphicon-trash"></i> ' +
        MESSAGES[159] +
        '</a>' +
        '</li>' +
        '<li>' +
        '<a class="action-nodedelete-group context-collapsible menu-manage" href="javascript:void(0)"><i class="glyphicon glyphicon-trash"></i> ' +
        MESSAGES[157] +
        '</a>' +
        '</li>' +
        '';
    ...
    if (ROLE == 'admin' || ROLE == 'editor') {
      ...
      var body =
        ...
        '" data-name="' +
        title +
        '" href="javascript:void(0)"><i class="glyphicon glyphicon-edit"></i> ' +
        MESSAGES[71] +
        '</a></li><li><a class="context-collapsible  action-networkdelete" data-path="' +
        network_id +
        '" data-name="' +
        title +
    ...
    if (ROLE == 'admin' || ROLE == 'editor') {
      ...
      var textObject_id = $(this).attr('data-path'),
        ...
        body =
          '<li>' +
          '<a class="context-collapsible  action-textobjectduplicate" href="javascript:void(0)" data-path="' +
          textObject_id +
          '">' +
          ...
          '</li>' +
          '<li>' +
          '<a class="context-collapsible  action-textobjecttoback" href="javascript:void(0)" data-path="' +
          textObject_id +
          '">' +
          '<i class="glyphicon glyphicon-save"></i> ' +
          MESSAGES[147] +
          ...
          '</li>' +
          '<li>' +
          '<a class="context-collapsible  action-textobjecttofront" href="javascript:void(0)" data-path="' +
          textObject_id +
          '">' +
          ...
          '</li>' +
          '<li>' +
          '<a class="context-collapsible  action-textobjectedit" href="javascript:void(0)" data-path="' +
          textObject_id +
          '">' +
          '<i class="glyphicon glyphicon-edit"></i> ' +
          MESSAGES[71] +
          ...
          '</li>' +
          '<li>' +
          '<a class="context-collapsible  action-textobjectdelete" href="javascript:void(0)" data-path="' +
          textObject_id +
          '">' +
          '<i class="glyphicon glyphicon-trash"></i> ' +
          MESSAGES[65] +
...
$(document).on('click', '.action-configsget', function (e) {
  ...
  $.when(getNodeConfigs(null))
    .done(function (configs) {
      var body =
        '<div class="row"><div class="config-list col-md-2 col-lg-2"><ul>';
      ...
      body +=
        '</ul></div><div id="config-data" class="col-md-10 col-lg-10"></div></div>';
...
function showRoutersContent(list) {
  ...
  $(document).on('click', '.rc_zhidao .r_btn', function (e) {
    ...
    var idx = Array.prototype.indexOf.call(
      document.querySelectorAll('.rc_zhidao .r_btn'),
      this
    );
  ...
  $(document).on('click', '.rc_zhidao .scale', function (e) {
    if ($('.rc_zhidao').css('width') === '500px')
      $('.rc_zhidao').css('width', '100%');
...
function showPeizhiRc(list) {
  ...
  var ctn = $(
    '<div class="rc_peizhi" style="position:fixed;z-index:' +
      (fixedZindex + 1) +
      ';left: 50%;top:50%;transform:translate(-50%,-50%);width:770px;height:608px;background:#fff;">' +
      ...
      '</div>' +
      '<div style="height:180px;overflow: auto;margin:10px 0;border-top: 1px solid #ccc;padding-top: 18px;color:#fff;">' +
      btns +
      '</div>' +
      '</div>' +
      '</div>'
  ...
  function peizhiRbtn(e) {
    ...
    $(this).addClass('cur');
    var idx = Array.prototype.indexOf.call(
      document.querySelectorAll('.rc_peizhi .r_btn'),
      this
    );
    curRouter = list[idx];
    ...
    tjPeizhiData(curRouter, function (data) {
      ...
      if (curAllSco == 0) {
        ...
        $('.rc_peizhi .r_btn')
          ...
          .css(
            'width',
            (((data.score || 0) / (curAllSco || 0)) * 100).toFixed(2) + '%'
          );
      }
    });
  }
  ...
  $(document).on('click', '#compare', function (e) {
    ...
    var dom = $(
      '<div class="rc_compare" style="position:fixed;z-index:' +
        ...
        '<div class="ans" style="height: ' +
        (ansH - 108) +
        'px;border:1px solid #ccc;overflow:auto;"></div>' +
        '<div style="text-align: center;margin-top:10px;">你的答案</div>' +
        '</div>' +
        '<div class="right" style="float:left;width:50%;">' +
        '<div class="ans" style="height: ' +
        (ansH - 108) +
        'px;border:1px solid #ccc;overflow:auto;"></div>' +
        '<div style="text-align: center;margin-top:10px;">标准答案</div>' +
        '</div>' +
        '</div>' +
        '</div>'
    );
    ...
    s_ajax(
      '/api/labAnswer/get',
      { labId: urlPre + labId, nodeId: curRouter.id },
      function (res) {
  ...
  $.when
    ...
    .done(function (data) {
      ...
      if (wrong.length > 0) {
        ...
        addModalWide(
          '提交配置',
          '<h1>' + wrongFirst.name + '</h1>提交失败，请重试',
          ''
        );
        return;
      }
      ...
      setTimeout(function () {
        addModalWide(
          '提交配置',
          '<h1>提交成功&nbsp;&nbsp;<span style="color: #ff3973;">' +
            score +
            '分</span></h1>',
          ''
        );
...
$(document).on(
  'click',
  '.action-nodedelete, .action-nodedelete-group',
  function (e) {
    if (!confirm('Are you sure ?')) return;
...
$(document).on('dblclick', '.action-labpreview', function (e) {
  logger(
    1,
    'DEBUG: opening a preview of lab "' + $(this).attr('data-path') + '".'
  );
...
$(document).on(
  'click',
  '.action-nodeplace, .action-networkplace, .action-customshapeadd, .action-textadd',
  function (e) {
    var target = $(this),
      object,
      frame = '';
  ...
  $.when(getPictures())
    .done(function (pictures) {
      if (!$.isEmptyObject(pictures)) {
        var body =
          '<div class="row"><div class="picture-list col-md-1 col-lg-1"><ul class="map">';
        ...
        body +=
          '</ul></div><div id="config-data" class="col-md-11 col-lg-11"></div></div>';
...
$(document).on(
  'click',
  '.action-nodesbootdelete, .action-nodesbootdelete-group',
  function (e) {
    $('#context-menu').remove();
    var isFreeSelectMode = $('#lab-viewport').hasClass('freeSelectMode');
    if (isFreeSelectMode) {
...
$(document).on(
  'click',
  '.action-nodesbootscratch, .action-nodesbootscratch-group',
  function (e) {
    $('#context-menu').remove();
...
$(document).on(
  'click',
  '.action-nodesbootsaved, .action-nodesbootsaved-group',
  function (e) {
    $('#context-menu').remove();
...
$(document).on(
  'click',
  '.action-nodeexport, .action-nodesexport, .action-nodeexport-group',
  function (e) {
    $('#context-menu').remove();
        ...
        if (isFreeSelectMode) {
          ...
          $.when(cfg_export(node_id))
            .done(function () {
              ...
              addMessage(
                'success',
                nodes[node_id]['name'] + ': ' + MESSAGES[79]
              );
            })
            .fail(function (message) {
              // Cannot export
...
$(document).on(
  'click',
  '.action-nodestart, .action-nodesstart, .action-nodestart-group',
  function (e) {
    $('#context-menu').remove();
    var node_id,
      startAll,
        ...
        if (isFreeSelectMode) {
          ...
          $.when(start(node_id))
            .done(function () {
              ...
              addMessage(
                'success',
                nodes[node_id]['name'] + ': ' + MESSAGES[76]
              );
              printLabStatus();
            })
            .fail(function (message) {
...
$(document).on(
  'click',
  '.action-nodestop, .action-nodesstop, .action-nodestop-group',
  function (e) {
    $('#context-menu').remove();
        ...
        if (isFreeSelectMode) {
          ...
          $.when(stop(node_id))
            .done(function () {
              ...
              addMessage(
                'success',
                nodes[node_id]['name'] + ': ' + MESSAGES[77]
              );
...
$(document).on(
  'click',
  '.action-nodewipe, .action-nodeswipe, .action-nodewipe-group',
  function (e) {
    $('#context-menu').remove();
        ...
        if (isFreeSelectMode) {
          ...
          $.when(wipe(node_id))
            .done(function () {
              ...
              addMessage(
                'success',
                nodes[node_id]['name'] + ': ' + MESSAGES[78]
              );
            })
            .fail(function (message) {
              // Cannot wipe
...
$(document).on('click', '.action-status', function (e) {
  ...
  $.when(getSystemStats())
    .done(function (data) {
      // Body
      var html =
        '<div id="statusModal" class="container col-md-12 col-lg-12">' +
        '<div class="fill-height row row-eq-height">' +
        '<div id="stats-text" class="col-md-3 col-lg-3">' +
        '<ul></ul>' +
        '</div>' +
      ...
      if (data['status'] == 'success') {
        ...
        if (type == 'POST') {
          ...
          if ($('#lab-viewport').length) {
            $('#lab-viewport').attr({
              'data-path':
                dirname(form_data['path']) + '/' + form_data['name'] + '.unl',
            });
            printLabTopology();
          } else {
            $.when(closeLab())
    ...
    var request = $.ajax({
      ...
      success: function (data) {
        if (data['status'] == 'success') {
          ...
          $('.network' + form_data['id'] + ' td:nth-child(2)').text(
            form_data['name']
          );
          $('.network' + form_data['id'] + ' td:nth-child(3)').text(
            form_data['type']
          );
    ...
    var request = $.ajax({
      ...
      success: function (data) {
        if (data['status'] == 'success') {
          ...
          $('body').children('.modal.fade.in').focus();
          addMessage(data['status'], data['message']);
          $('.modal .node' + form_data['id'] + ' td:nth-child(2)').text(
            form_data['name']
          );
          $('.modal .node' + form_data['id'] + ' td:nth-child(3)').text(
            form_data['template']
          );
          $('.modal .node' + form_data['id'] + ' td:nth-child(4)').text(
            form_data['image']
          );
          $('.modal .node' + form_data['id'] + ' td:nth-child(5)').text(
            form_data['cpu']
          );
          $('.modal .node' + form_data['id'] + ' td:nth-child(7)').text(
            form_data['nvram']
          );
          $('.modal .node' + form_data['id'] + ' td:nth-child(8)').text(
            form_data['ram']
          );
          $('.modal .node' + form_data['id'] + ' td:nth-child(9)').text(
            form_data['ethernet']
          );
          $('.modal .node' + form_data['id'] + ' td:nth-child(10)').text(
            form_data['serial']
          );
          $('.modal .node' + form_data['id'] + ' td:nth-child(11)').text(
            form_data['console']
          );
          ...
          $('#node' + form_data['id'] + ' a img').attr(
            'src',
            '/images/icons/' + form_data['icon']
          );

          $(
            "#form-node-edit-table input[name='node[name]'][data-path='" +
              form_data['id'] +
              "']"
          ).val(form_data['name']);
          $(
            "#form-node-edit-table select[name='node[image]'][data-path='" +
              form_data['id'] +
              "']"
          ).val(form_data['image']);
          $(
            "#form-node-edit-table input[name='node[cpu]'][data-path='" +
              form_data['id'] +
              "']"
          ).val(form_data['cpu']);
          $(
            "#form-node-edit-table input[name='node[nvram]'][data-path='" +
              form_data['id'] +
              "']"
          ).val(form_data['nvram']);
          $(
            "#form-node-edit-table input[name='node[serial]'][data-path='" +
              form_data['id'] +
              "']"
          ).val(form_data['serial']);
          $(
            "#form-node-edit-table input[name='node[ethernet]'][data-path='" +
              form_data['id'] +
              "']"
          ).val(form_data['ethernet']);
          $(
            "#form-node-edit-table select[name='node[console]'][data-path='" +
              form_data['id'] +
              "']"
          ).val(form_data['console']);
          $(
            "#form-node-edit-table select[name='node[icon]'][data-path='" +
              form_data['id'] +
              "']"
          ).val(form_data['icon']);
        } else {
...
$(document).on('submit', '#form-user-add, #form-user-edit', function (e) {
  ...
  if (form_data['expiration'] == '') {
    ...
    form_data['expiration'] = Math.floor(
      $.datepicker.formatDate('@', new Date(form_data['expiration'])) / 1000
    );
  }
  if (form_data['pexpiration'] == '') {
    form_data['pexpiration'] = -1;
  } else {
    form_data['pexpiration'] = Math.floor(
      $.datepicker.formatDate('@', new Date(form_data['pexpiration'])) / 1000
    );
  }
  if (form_data['pod'] == '') {
    form_data['pod'] = -1;
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data['status'] == 'success') {
        ...
        printPictureInForm(picture_id);
        $('ul.map a.action-pictureget[data-path="' + picture_id + '"]').attr(
          'title',
          form_data['name']
        );
        $('ul.map a.action-pictureget[data-path="' + picture_id + '"]').text(
...
$('body').on('submit', '.custom-shape-form', function (e) {
  ...
  shape_options['shape_type'] = $(
    '.custom-shape-form .shape-type-select'
  ).val();
  // shape_options['shape_name'] = $('.custom-shape-form .shape_name').val();
  if (!$('.custom-shape-form .shape_name').val()) {
    generateName = true;
    shape_options['shape_name'] =
      $('.custom-shape-form .shape-type-select').val() + customShape_id;
  } else {
    shape_options['shape_name'] = $('.custom-shape-form .shape_name').val();
  }
  shape_options['shape_border_type'] = $(
    '.custom-shape-form .border-type-select'
  ).val();
  shape_options['shape_border_color'] = $(
    '.custom-shape-form .shape_border_color'
  ).val();
  shape_options['shape_background_color'] = $(
    '.custom-shape-form .shape_background_color'
  ).val();
  shape_options['shape_width/height'] = 120;
  shape_options['shape_border_width'] = $(
    '.custom-shape-form .shape_border_width'
  ).val();
  shape_options['shape_left_coordinate'] = $(
    '.custom-shape-form .left-coordinate'
  ).val();
  shape_options['shape_top_coordinate'] = $(
    '.custom-shape-form .top-coordinate'
  ).val();
  ...
  if (shape_options['shape_type'] == 'square') {
    shape_html =
      '<div id="customShape' +
      shape_options['id'] +
      '" class="customShape context-menu" data-path="' +
      customShape_id +
      '" ' +
      'style="display:inline;z-index:' +
      z_index +
      ';' +
      coordinates +
      '" ' +
      'width="' +
      shape_options['shape_width/height'] +
      'px" height="' +
      shape_options['shape_width/height'] +
      'px" >' +
      '<svg width="' +
    ...
    radius =
      shape_options['shape_width/height'] / 2 -
      shape_options['shape_border_width'] / 2;
    ...
    shape_html =
      ...
      '">' +
      '<ellipse cx="' +
      (radius + shape_options['shape_border_width'] / 2) +
      '" ' +
      'cy="' +
      (radius + shape_options['shape_border_width'] / 2) +
      '" ' +
    ...
    .done(function (textObjData) {
      ...
      getTextObjects()
        .done(function (textObjects) {
          ...
          $added_shape.attr('data-path', textObjData.id);
          var new_data = document.getElementById(
            $added_shape.attr('id')
          ).outerHTML;
...
$('body').on('submit', '.add-text-form', function (e) {
  ...
  text_options['text_left_coordinate'] = $(
    '.add-text-form .left-coordinate'
  ).val();
  text_options['text_top_coordinate'] = $(
    '.add-text-form .top-coordinate'
  ).val();
  text_options['text'] = $('.add-text-form .main-text')
    .val()
    .replace(/\n/g, '<br>');
  text_options['alignment'] = 'center';
  text_options['vertical-alignment'] = 'top';
  text_options['color'] = $('.add-text-form .text_font_color').val();
  text_options['background-color'] = $(
    '.add-text-form .text_background_color'
  ).val();
  text_options['text-size'] = $('.add-text-form .text_font_size').val();
  text_options['text-style'] = $(
    '.add-text-form .text-font-style-select'
  ).val();
  ...
  text_html =
    '<div id="customText' +
    text_options['id'] +
    '" class="customShape customText context-menu" data-path="' +
    customShape_id +
    '" ' +
    ...
    ';" >' +
    '<p align="' +
    text_options['alignment'] +
    '" style="' +
    'vertical-align:' +
    text_options['vertical-alignment'] +
    ';' +
    'color:' +
    text_options['color'] +
    ';' +
    ...
    getTextObjects()
      .done(function (textObjects) {
        ...
        $duplicated_shape.css(
          'top',
          parseInt($selected_shape.css('top')) +
            parseInt($selected_shape.css('width')) / 2
        );
        $duplicated_shape.css(
          'left',
          parseInt($selected_shape.css('left')) +
            parseInt($selected_shape.css('height')) / 2
        );
...
$('body').on(
  'contextmenu',
  '.edit-custom-shape-form, .edit-custom-text-form, #context-menu',
  function (e) {
    e.preventDefault();
    e.stopPropagation();
  }
...
$('body').on(
  'change',
  '.edit-custom-text-form .text-z_index-input',
  function (e) {
    logger(1, 'DEBUG: action = action-change text z-index');
    var id = $(this).attr('data-path');
    $('#customText' + id).css(
      'z-index',
      parseInt($('.edit-custom-text-form .text-z_index-input').val()) + 1000
    );
  }
);
...
$('body').on(
  'change',
  '.edit-custom-text-form .text_background_color',
  function (e) {
...
$('body').on(
  ...
  function (e) {
    ...
    if (
      $('.edit-custom-text-form .text_background_transparent').hasClass(
        'active'
      )
    ) {
      $('.edit-custom-text-form .text_background_transparent')
...
$('body').on('change', '.edit-custom-text-form .text_color', function (e) {
  ...
  $('#customText' + id + ' p').css(
    'color',
    $('.edit-custom-text-form .text_color').val()
  );
});

$('body').on(
  'change',
  '.edit-custom-text-form .text-rotation-input',
  function (e) {
...
$('body').on('click', '.edit-custom-text-form .cancelForm', function (e) {
  ...
  $('#customText' + id).css(
    'z-index',
    parseInt($('.edit-custom-text-form .firstTextValues-z_index').val())
  );
  ...
  if ($('.edit-custom-text-form .firstTextValues-align').val() == 'left') {
    ...
    $('.edit-custom-text-form .firstTextValues-align').val() == 'center'
  ) {
    $('#customText' + id + ' p').attr('align', 'center');
  } else if (
    $('.edit-custom-text-form .firstTextValues-align').val() == 'right'
  ) {
    $('#customText' + id + ' p').attr('align', 'right');
  }
...
$(document).on('focusout', '.editable', function (e) {
  ...
  if (textLines) {
    ...
    $selected_shape.css(
      'height',
      parseFloat($('p', $selected_shape).css('font-size')) *
        (textLines * 1.5 + 1) +
        'px'
    );
  } else {
    ...
    $selected_shape.css(
      'height',
      parseFloat($('p', $selected_shape).css('font-size')) * 2 + 'px'
    );
  }
...
$('body').on('click', '.edit-custom-shape-form .cancelForm', function (e) {
  ...
  $('#customShape' + id).css(
    'z-index',
    parseInt($('.edit-custom-shape-form .firstShapeValues-z_index').val())
  );
  ...
  if (
    ...
    $('#customShape' + id + ' svg')
      ...
      .attr(
        'stroke-width',
        $('.edit-custom-shape-form .firstShapeValues-border-width').val() / 2
      );
  } else {
    $('#customShape' + id + ' svg')
      .children()
  ...
  if (
    $('.edit-custom-shape-form .firstShapeValues-border-type').val() == 'solid'
  ) {
    $('#customShape' + id + ' svg')
      .children()
      .removeAttr('stroke-dasharray');
  } else if (
    $('.edit-custom-shape-form .firstShapeValues-border-type').val() == 'dashed'
  ) {
    if (
      !$('#customShape' + id + ' svg')
        .children()
...
$('body').on(
  'change',
  '.edit-custom-shape-form .shape-z_index-input',
  function (e) {
    logger(1, 'DEBUG: action = action-change shape z-index');
    var id = $(this).attr('data-path');
    $('#customShape' + id).css(
      'z-index',
      parseInt($('.edit-custom-shape-form .shape-z_index-input').val()) + 1000
    );
  }
);
...
$('body').on(
  'change',
  '.edit-custom-shape-form .shape_border_width',
  function (e) {
    ...
    if (
      ...
      $('#customShape' + id + ' svg')
        ...
        .attr(
          'stroke-width',
          $('.edit-custom-shape-form .shape_border_width').val() / 2
        );
    } else {
      $('#customShape' + id + ' svg')
        .children()
...
$('body').on(
  'change',
  '.edit-custom-shape-form .border-type-select',
  function (e) {
    ...
    if ($('.edit-custom-shape-form .border-type-select').val() == 'solid') {
      ...
      $('.edit-custom-shape-form .border-type-select').val() == 'dashed'
    ) {
      if (
        !$('#customShape' + id + ' svg')
          .children()
...
$('body').on(
  'change',
  '.edit-custom-shape-form .shape_background_color',
  function (e) {
...
$('body').on(
  ...
  function (e) {
    ...
    if (
      $('.edit-custom-shape-form .shape_background_transparent').hasClass(
        'active'
      )
    ) {
      $('.edit-custom-shape-form .shape_background_transparent')
      ...
      $('#customShape' + id + ' svg')
        ...
        .attr(
          'fill',
          hex2rgb($('.edit-custom-shape-form .shape_background_color').val(), 0)
        );
    }
  }
);
...
$('body').on(
  'change',
  '.edit-custom-shape-form .shape_border_color',
  function (e) {
...
$('body').on(
  'change',
  '.edit-custom-shape-form .shape-rotation-input',
  function (e) {
    logger(1, 'DEBUG: action = action-rotate shape');
    var id = $(this).attr('data-path'),
      angle = parseInt(this.value);
...
$(document).on(
  'click',
  '#lab-viewport.freeSelectMode .node_frame',
  function (event) {
    ...
    if (isFreeSelected) {
      ...
      window.freeSelectedNodes = window.freeSelectedNodes.filter(function (
        node
      ) {
        ...
        if ($.inArray(key, ['ethernet', 'serial']) > -1)
          $.each(value, function (id, object) {
            ...
            if (networks[object['network_id']]) {
              ...
              network +=
                //edit
                '<a class="action-networkedit" data-path="' +
                object['network_id'] +
                '" ' +
                'data-name="' +
                object['name'] +
                '" href="#" title="Edit network">' +
                '<i class="glyphicon glyphicon-pencil"></i></a>' +
                //deatach
                '<a class="action-networkdeatach" data-path="' +
                object['network_id'] +
                '" ' +
                'data-name="' +
                object['name'] +
                '" href="#" title="Detach interface"' +
                'node-id="' +
                node_id +
                '"' +
                'interface-id="' +
          ...
          $.each(interfaces, function (id, nodeInterface) {
            $.each(nodeInterface['ethernet'], function (id, object) {
              if (object.network_id == start_network_id) {
                network.push(
                  setNodeInterface(nodeInterface.id, network_id, id)
                );
              }
            });
          });
...
$(document).on('click', 'a.interfaces', function (e) {
  ...
  var isNetworkId =
    typeof $(this).attr('network-id') !== 'undefined'
      ? $(this).attr('network-id')
      : 0;
  ...
  if (isStartNode) {
      ...
      $.when(getNodeInterfaces(end_node))
        .then(function (nodeInterface) {
          ...
          if (hasNetwork && window.startNode.created) {
            return setNodeInterface(
              window.startNode.nodeId,
              isNetworkId,
              interface_id
            );
          } else {
    ...
    var node_name =
      $('.node' + start_node).attr('data-name') + '-' + interface_name;
...
$(document).on('click', '.node.node_frame a', function (e) {
  ...
  if (!status) {
    ...
    $.when(getNodes(node_id))
      .then(function (node) {
        var network =
          '<li><a class="action-nodestart menu-manage" data-path="' +
          node_id +
          '" data-name="' +
          node.name +
